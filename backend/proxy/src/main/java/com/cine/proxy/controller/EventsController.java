...
public class EventsController {
    ...
    //         // Recuperamos las claves de eventos
    //         List<String> eventos = List.of("evento_1", "evento_2", "evento_3", "evento_4", "evento_5"); // Cambiar si manejás más eventos y centralizás las claves
    ...
    //         // Recuperamos las claves de eventos
    //         List<String> eventos = List.of("evento_1", "evento_2"); // Cambiar si manejás más eventos y centralizás las claves
